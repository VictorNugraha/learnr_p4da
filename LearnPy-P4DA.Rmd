...
```{r lat1, echo=FALSE}
question("Berdasarkan pilihan dibawah ini, manakah struktur data yang bisa kita tentukan index dan nilainya?", type = "single",
...
```{python data, echo=FALSE, message=FALSE, warning=FALSE}
...
```{python lat5, exercise = TRUE, exercise.setup = "data"}
